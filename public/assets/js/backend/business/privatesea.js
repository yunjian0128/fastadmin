...
define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'business/privatesea/index', // 列表查询的请求控制器方法
                    add_url: 'business/privatesea/add', // 添加的控制器地址
                    edit_url: 'business/privatesea/edit', // 编辑的控制器地址
                    del_url: 'business/privatesea/del', // 删除的控制器地址
                    recovery_url: 'business/privatesea/recovery', // 回收的控制器地址
                    info_url: 'business/privateseainfo/index', // 详情的控制器地址
                    table: 'business',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    ...
                    { field: 'mobile', title: __('Mobile'), operate: false, sortable: true },
                    { field: 'email', title: __('Email'), operate: false, sortable: true },
                    ...
                    { field: 'admin.username', title: __('Admin'), operate: false, sortable: true },
                    {
                        field: 'operate',
                        title: __('Operate'),
                        table: table,
                        ...
                        buttons: [
                            {
                                name: 'info', // 跟table页面中绑定一样
                                title: '详情',
                                icon: 'fa fa-list', // 图标
                                classname: 'btn btn-xs btn-info btn-dialog', // 按钮样式
                                url: $.fn.bootstrapTable.defaults.extend.info_url, // 请求地址
                                extend: 'data-toggle=\'tooltip\' data-area= \'["50%", "90%"]\'', // 弹出框的大小
                            },
