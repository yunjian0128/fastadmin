define(["jquery", "bootstrap", "backend", "table", "form"], function (
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: "hotel/room/index", // 列表查询的请求控制器方法
                    add_url: "hotel/room/add", // 添加的控制器地址
                    edit_url: "hotel/room/edit", // 编辑的控制器地址
                    del_url: "hotel/room/del", // 删除的控制器地址
                    table: "hotel_room", // 当前表格的名称
                },
            });
